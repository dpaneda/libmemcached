...
typedef enum {
  ...
  MEMCACHED_BEHAVIOR_CHECK_OPAQUE,
  MEMCACHED_BEHAVIOR_UDP_ALWAYS_FLUSH,
  MEMCACHED_BEHAVIOR_MGET_FLUSH_OLD_RESULTS,
  MEMCACHED_BEHAVIOR_HASH_PORT_CONSISTENT,
